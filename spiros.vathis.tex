...
%{Kon/nou  Kavafi 120}
%{Patra 26335}
{Patras, Greece}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\cvitem{Title}{\emph{Geolocation data enabled web mashups }\href{http://hdl.handle.net/11128/268}{\faExternalLink}}
\cvitem{Supervisor}{Dimitris Kalles}
\cvitem{Abstract}{This thesis presents the analysis, design and development process of an information system that combines and interlinks existing web services that operate independently on a large scale, utilizing geo-location information.
...
\section{Interests}
\cvitem{Photography}{I am a film photography enthusiast. I collect old and broken film cameras and manual focus lenses, I repair them and shoot photos with them.}
\cvitem{Hiking}{I enjoy hiking on mountain tops and take extraordinary photos from there.}
\cvitem{Cycling}{I am a casual cyclist covering 50 to 100 km weekly.}

\section{Interests}
\cvlistitem{Photography - I am a film photography enthusiast. I collect old and broken film cameras and manual focus lenses, I repair them and shoot photos with them.}
\cvlistitem{Casual cyclist covering 50 to 100 km weekly.}
