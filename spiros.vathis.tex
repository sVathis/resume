...
{An experienced software engineer with strong professional background in design and implementation of high performance, data-intensive, real-time applications. With more than 20 years of technical experience on several platforms and environments, ranging from high performance system programming on Solaris \& FreeBSD, performance tuning and optimization of legacy Java based systems to OpenGL programming in Windows, I possess leadership skills from within numerous functional areas of software engineering. Additionally, my mathematical background (I hold a B.Sc. in mathematics) provides me the analytical thinking skills required in acute problem solving situations.}
...
\section{Professional Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Principal Senior Software Engineer}{Mar 2018 - Nov 2021}
      \newline \\As a Principal Software Engineer I was leading teams in delivering features in various products and services. In parallel I contributed in growing these teams by mentoring team members, delivering trainings in brown-bag sessions, interviewing candidates for hire etc. I highlight some key items:
      \resumeItemListStart
      \resumeItem{Citrix SDWAN Edge Security}
          {I was the team leader for \href{https://docs.citrix.com/en-us/tech-zone/learn/tech-briefs/citrix-sdwan-edge-security.html}{\fancyhref{Citrix SD-WAN Edge Security}}, a feature that provides Intrusion Detection, Web Filtering, and Anti-Malware natively in On-premises appliances for enterprises that use Citrix SD-WAN.
          \begin{multicols}{2}
            ...
            \columnbreak
            \emph{Achievements}\\
            Delivered a feature that:\\
            • Simplifies information security management for protecting the SDWAN branch network from internet threats\\
            • Provides a single management and reporting pane for various security functionalities along with SD-WAN\\
            • Eliminates the need for multiple branch solutions, by consolidating routing, SD-WAN, and security capabilities on a single appliance\\
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{palmnews.gr}
      {Created on 1999 and running until 2001, \href{http://web.archive.org/web/20010401151451/http://www.palmnews.gr/}{\fancyhref{http://palmnews.gr}} was the first Greek portal on Palm personal digital assistant (PDA) }
  \resumeSubHeadingListEnd
